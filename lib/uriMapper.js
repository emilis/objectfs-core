...
// URI map:
var uri_map = [
    { scheme:"sqlite",   package:"ofs-sqlite" },
    { path:"*.sqlite",   package:"ofs-sqlite" },
    { scheme:"csv",      package:"objectfs-core/drivers/csv" },
    { path:"*.csv",      package:"objectfs-core/drivers/csv" },
];
...
exports.getFs = function(uri, ofs_options) {
    ...
    var package_name = this.findPackageForUri(uri);
    ...
    if (!package_name) {
        ...
        var fs = core.cloneModule(package_name);
        fs.connect(uri, ofs_options, ioHandler);
        return fs;
    }
};
 ...
 *
 */
exports.findPackageForUri = function(uri) {

    var match = false;
    for each (var pattern in uri_map) {
        ...
        //print(uri.uri, score, uneval(pattern));
    }
 ...
 *
 */
function init_uri_map() {

    uri_map = uri_map.map(function(pattern){
