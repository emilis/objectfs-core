...
var uriMap = require("objectfs-core/uriMap");
uriMap.connect();
...
exports.getFs = function(uri, ofs_options) {
    ...
    var package = this.findPackageForUri(uri);
    ...
    if (!package) {
        ...
        var fs = core.cloneModule(package.name);

        uri.params = objects.merge(uri.params, package.options);
