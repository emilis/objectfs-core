...
exports.read = function(uri, id) {
    ...
    var fs = mapper.getFs(uri, {read_only:true, one_pass:true});
    return fs.read(id);
};
...
exports.write = function(uri, id, obj) {
    ...
    var fs = mapper.getFs(uri, {write_only:true, one_pass:true});
...
exports.list = function(uri, filter) {
    ...
    var fs = mapper.getFs(uri, {read_only:true, one_passs:true});
...
exports.mirror = function(src, target) {
    ...
    var fs1 = mapper.getFs(src, {read_only:true, one_pass:true});
