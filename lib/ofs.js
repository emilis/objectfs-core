...
exports.read = function(uri, id) {
    ...
    var fs = mapper.getFs(uri, {read_only:true, one_call:true});
    return fs.read(id);
};
...
exports.write = function(uri, id, obj) {
    ...
    var fs = mapper.getFs(uri, {write_only:true, one_call:true});
...
exports.list = function(uri, filter) {
    ...
    var fs = mapper.getFs(uri, {read_only:true, one_calls:true});
...
exports.mirror = function(src, target) {
    ...
    var fs1 = mapper.getFs(src, {read_only:true, one_call:true});
    var fs2 = mapper.getFs(target, {write_only:true, batch:true});
